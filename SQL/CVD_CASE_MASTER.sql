CREATE SEQUENCE  "SYSTEM"."CASE_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 10 CACHE 20 NOORDER  NOCYCLE;
...
BEFORE INSERT ON "SYSTEM"."CVD_CASE_MASTER"
FOR EACH ROW
...
select * from "SYSTEM"."CVD_CASE_MASTER";
